...
DESIRED_IMAGE_NUMBER = 50  # if using mini_data_for_python, max number is 50
DISTRIBUTION_TYPE = "extremes"  # options: ["all","balanced","extremes","colors"]
...
COLOR_TO_LABEL = {"Unclassified": -1, "Blue": 0, "Red": 1, "Green": 2}
...
LOAD_SVM_MODEL_PATH = ""  # e.g. "/absolute/path/to/Google/Drive/Shortcut/mini_data_for_python/svm_model__red_blue_2000Images.pkl"  # e.g. "/absolute/path/to/Google/Drive/Shortcut/mini_data_for_python/svm_model__euclidean_red_blue_2000Images.pkl"

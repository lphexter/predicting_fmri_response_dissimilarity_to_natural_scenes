...
def generate_pair_indices(rdm):
    """
    row_indices, col_indices for all i<j in an NxN RDM, plus the RDM values.
    """
...
def train_test_split_pairs(row_indices, col_indices, rdm_values, test_size=0.2, random_state=42):
    """
    Splits the pairwise indices + RDM values into train/test sets.
    """
...
class PairDataset(Dataset):
    """
    A custom dataset that yields (concatenated pair of embeddings, RDM_value).
    """
